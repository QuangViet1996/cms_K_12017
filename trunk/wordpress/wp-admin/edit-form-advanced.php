...
<div><div style="font-size: 20px ; padding-bottom: 20px;"> overview</div>	
<textarea name="post_overview" style="Width:100%" row="5"><?php echo esc_attr($post->post_overview);?></textare>
